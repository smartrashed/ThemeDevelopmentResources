...
class Burder_Includes {
	...
	public static function init()
	{
		...
		{		
			...
			self::include_child_first('/widget.php'); 
	...
	public static function _menu_action_init(){
		self::include_child_first('/burder_multi_page_navwalker.php');
		self::include_child_first('/burder_one_page_bootstrap_navwalker.php');
	}
	/**
	 * @internal
	 */
